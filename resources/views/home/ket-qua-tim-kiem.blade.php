...
@section('title')
    <title>TÌM KIẾM | ĐỒ DÙNG NHÀ BẾP K.COOK</title>
@endsection
@section('seo-meta')
    <meta name="title" content="TÌM KIẾM | ĐỒ DÙNG NHÀ BẾP K.COOK" />
    <meta property="og:title" content="TÌM KIẾM | ĐỒ DÙNG NHÀ BẾP K.COOK" />
@endsection
@section('content')
    <main id="main" class="">
                ...
                <div class="col large-9">
                    <div class="shop-container">
                        @if (count($listSanPham) > 0)
                            <h5>Có {{ count($listSanPham) }} kết quả tìm kiếm với từ khoá: "{{ $key }}"</h5>
                        @else
                            <h5>Rất tiếc, không tìm thấy kết quả tìm kiếm với từ khoá: "{{ $key }}"</h5>
                        @endif
                        <div
                                            ...
                                            <div class="product-small box h-100">
                                                <div class="box-image">
                                                    <div class="image-zoom-fade">
                                                        <a href="@if (!empty($sanPham->slug)){{ route('home.chi_tiet_san_pham', $sanPham->slug) }} @else 'a' @endif">
