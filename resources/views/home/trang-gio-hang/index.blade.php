                    ...
                    <div class="col-inner">
                        <div class="woocommerce">
                            <div class="row-thanh-toan cart-in-mobile" id="render-cart-empty">
                                {{-- @include('home.trang-gio-hang.ds-gio-hang') --}}
                                <form id="form-dat-hang" data-parsley-validate method="post" class="w-100"
                                    action="{{ route('home.thanh_toan_don_hang') }}">
                                    @csrf
                                    <div class="row-cart-item">
                                        <div id="render-cart" class="col large-6 pb-0">
                                            @include('home.trang-gio-hang.gio-hang')
                                        </div>
                                        <div class="col large-3" id="render-cart-info">
                                            @include('home.trang-gio-hang.thong-tin-khach-hang')
                                        </div>
                                        <div class="col large-3" id="render-cart-pay">
                                            @include('home.trang-gio-hang.hinh-thuc-thanh-toan')
                                        </div>
                                    </div>
                                </form>
                            </div>
...
@section('page-js')
    ...
    <script>
        ...
        function updateItemListCart(id, so_luong) {
            $.ajax({
                url: '/cap-nhat-san-pham-trong-gio-hang/' + Number(id) + '/' + Number(so_luong),
                type: 'GET',
            }).done(function(res) {
                Render(res)
                tangSanPham();
