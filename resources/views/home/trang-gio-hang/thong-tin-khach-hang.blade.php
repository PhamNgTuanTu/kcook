<div>
    <div class="customer">
        ...
        <div class="form-group">
            <input name="name" type="text" placeholder="Họ và tên *" class="form-control" value="" required
                data-parsley-required-message="Vui lòng nhập họ tên" data-parsley-maxlength="50"
        ...
        <div class="form-group">
            <input name="email" type="email" data-parsley-trigger="change" required placeholder="Địa chỉ E-mail *"
                class="form-control" value="" data-parsley-type-message="Email không đúng định dạng"
                data-parsley-type="email" data-parsley-required-message="Vui lòng nhập email"
                data-parsley-maxlength="255" data-parsley-maxlength-message="Vui lòng nhập email ít hơn 255 kí tự"
        ...
        <div class="form-group">
            <input name="address" type="text" data-parsley-trigger="change" required
                ...
                class="form-control" value="" data-parsley-maxlength="255"
