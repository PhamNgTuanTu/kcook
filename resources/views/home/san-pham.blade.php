...
@section('title')
    <title>SẢN PHẨM | ĐỒ DÙNG NHÀ BẾP K.COOK</title>
@endsection
@section('seo-meta')
    <meta name="title" content="SẢN PHẨM | ĐỒ DÙNG NHÀ BẾP K.COOK" />
    <meta property="og:title" content="SẢN PHẨM | ĐỒ DÙNG NHÀ BẾP K.COOK" />
@endsection
@section('content')
    <main id="main" class="">
                ...
                <div class="col large-9">
                    <div class="shop-container">
                        <div class="product_list clear">
                            <h2 class="heading">Tất cả sản phẩm
                            </h2>
...
@section('page-js')
    ...
    <script>
        ...
        function userAddCart(id) {
            $.ajax({
                url: '/them-san-pham-vao-gio-hang/' + id,
