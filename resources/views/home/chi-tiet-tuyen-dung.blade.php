...
@section('title')
    <title>CHI TIẾT TUYỂN DỤNG | ĐỒ DÙNG NHÀ BẾP K.COOK</title>
@endsection
@section('seo-meta')
        ...
        <div id="content" class="blog-wrapper blog-archive page-wrapper">
            <div class="row row-divided ">
                ...
                <div class="large-9 col medium-col-first">
                    <article id="post-227"
                        class="post-227 post type-post status-publish format-standard has-post-thumbnail hentry category-tin-tuc">
                                    ...
                                    <div class="entry-meta is-small single-date">
                                        <span class="posted-on">
                                            ...
                                            <time class="entry-date published"
                                                datetime="2017-07-25T06:29:51+00:00">{{ $tinTuc->created_at }}</time>
                                        </span>
                                        <span class="byline">
                                    ...
                                    <div class="row large-columns-3 medium-columns-2 small-columns-1 has-shadow row-box-shadow-1 row-box-shadow-1-hover"
                                        ...
                                        @foreach ($tinTucLienQuan as $tinTuc)
                                            <div class="col post-item">
                                                <div class="col-inner">
                                                    <a href="{{ route('home.chi_tiet_tuyen_dung', $tinTuc->slug) }}"
                                                        class="plain">
                                                        <div class="box box-bounce box-text-bottom box-blog-post has-hover">
                                                            <div class="box-image">
                                                                <div class="image-cover" style="padding-top: 56%;">
                                                                    <img width="800" height="531" src="{{ $tinTuc->anh }}"
                                                            ...
                                                            <div class="box-text text-center">
                                                                <div class="box-text-inner blog-post-inner">
                                                                    <h5 class="post-title is-large font-16">{{ $tinTuc->tieu_de }}
                                                                    </h5>
                                                                    <div class="post-meta is-small op-8 font-14">
                                                                        {!! mb_strimwidth($tinTuc->phu_de, 0, 100, '[...]') !!}</div>
