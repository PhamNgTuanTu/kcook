            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <p class="">Hệ thống quản trị KCOOK - CMS.</p>
                        <form class="text-left" action="{{ route('postLogin') }}" method="post">
                            ...
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="ten-dang-nhap" name="ten_dang_nhap" type="text" class="form-control"
                                ...
                                <div id="password-field" class="field-wrapper input mb-2">
                                    ...
                                    <input id="mat-khau" name="mat_khau" type="password" class="form-control"
                                    ...
                                    @if (session('status_admin'))
                                        <ul class="error-login-cms">
                                            <li class="notification-message"> {{ session('status_admin') }}</li>
                                        </ul>
                                    @endif
                                </div>
